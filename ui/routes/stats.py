...
def _build_stats_rows(config, state):
    """Build enriched indexer stats rows. Reusable by indexers page."""
    indexer_rows = []
    scored_data = {}
...
def stats():
    """Redirect to Indexers hub Stats tab."""
    return redirect("/indexers/stats", code=301)
